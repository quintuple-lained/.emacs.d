...
(custom-set-variables
 ...
 '(package-selected-packages
   '(## ace-jump-mode base16-theme cargo-mode elgot fancy-battery
	git-gutter-fringe json-mode latex-preview-pane lsp-mode magit
	nyan-mode org-roam os-csl rust-mode smartparens
	solarized-gruvbox-theme symon
	use-package-ensure-system-package vterm yaml-mode)))
